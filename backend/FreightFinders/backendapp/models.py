...
class LoadPosting(models.Model):
    # id = models.BigAutoField()  # Assuming 'id' is the primary key
    load_id = models.CharField(max_length=255, primary_key = True)
...
class LoadStop(models.Model):
    ...
    load = models.ForeignKey(LoadPosting, on_delete=models.CASCADE, db_column='load_id', related_name='loadid_stops')
